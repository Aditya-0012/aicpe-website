...
export default function RegularMemberForm() {
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    try {
      const res = await submitMember('regular', data);
  ...
  if (success) return (
    <div className="form-page page-enter">
      <div className="form-header form-header--saffron">
        <div className="container"><h1 className="form-header-title">Regular Member</h1></div>
      </div>
      <div className="container form-body">
        <div className="form-card">
          <SuccessScreen membershipId={success} memberType="Regular" onReset={() => { reset(); setSuccess(null); }} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <FormWrapper
      title="Regular Member Registration"
      subtitle="For qualified professionals actively working in physical education"
      fee="₹1,000 / year"
      icon="🏅"
      color="saffron"
    >
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        <FormSection title="Personal Information">
          ...
          <FormRow cols={3}>
            ...
            <div className="form-group">
              ...
              <input className="form-input" defaultValue="Indian" {...register('nationality')} />
            </div>
          </FormRow>
        </FormSection>
        ...
        <FormSection title="Professional Information">
          <FormRow cols={2}>
            ...
            <div className="form-group">
              ...
              <input className="form-input" placeholder="e.g. Physical Education Teacher, Coach"
          ...
          <FormRow cols={2}>
            <div className="form-group">
              ...
              <input className="form-input" placeholder="Current employer / institution"
        ...
        <FormSection title="Payment Information">
          ...
          <div style={{ background: 'var(--saffron-light)', border: '1px solid #f5c279', borderRadius: 8, padding: '12px 16px', fontSize: '0.85rem', color: '#92400e', marginBottom: 20 }}>
            <strong>Fee: ₹1,000/year</strong> | DD/Cheque in favour of "AICPE" payable at Bhopal. Online: UPI cp@aicpe
          </div>
        </FormSection>
